...
def ret_candidate_points(x0, z0, offsets):
...
def ret_offset_value(road_map, x0, z0, radius):
    offsets01, offsets02, offsets03, offsets04 = circle_offsets_by_quadrant(radius)

    candidate_points01 = ret_candidate_points(x0, z0, offsets01)
    candidate_points02 = ret_candidate_points(x0, z0, offsets02)
    candidate_points03 = ret_candidate_points(x0, z0, offsets03)
    candidate_points04 = ret_candidate_points(x0, z0, offsets04)
...
def main(radius):
    ...
    for x0, z0 in tqdm(road_coords, desc="探索中"):
        ...
        for retry in range(max_retry + 1):
            ...
            offset_values = ret_offset_value(road_map, x0, z0, r)
...
for RADIUS in [10, 20, 30, 50, 100]:
    quadrant_map = main(radius=RADIUS)
